...
function renderCoordinate(data, options = {}) {
  ...
  const latStr = formatCoordinate(lat, "N", "S");
  const lngStr = formatCoordinate(lng, "E", "W");
...
const CoordinatePlugin = {
  ...
  render: renderCoordinate,

  preview(data, options = {}) {
    const result = renderCoordinate(data, options);
